...
enum Palette {
    static func accent(_ name: String) -> Color {
        switch name { case "Ozean": return .blue; case "Violett": return .purple; case "Sonnenuntergang": return .orange; default: return .cyan }
    }
    ...
    var body: some View {
        ZStack {
            ...
            GeometryReader { proxy in
                Circle().fill(.cyan.opacity(scheme == .dark ? 0.16 : 0.09)).frame(width: 320).blur(radius: 85)
